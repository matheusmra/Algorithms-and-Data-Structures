    ...
    public static void main(String[] args) {
        ...
        try {
            BufferedReader br = new BufferedReader(new InputStreamReader(
                new FileInputStream("C:\\Users\\mathe\\OneDrive\\Documentos\\Faculdade\\AEDS2\\TPS\\04\\games.csv"), 
                "UTF-8"));
        ...
        while (!(entrada = scanner.nextLine()).equals("FIM")) {
            try {
                ...
                // Procurar o jogo com o ID especificado
                for (Game game : games) {
                    if (game.getGameId() == idProcurado) {
